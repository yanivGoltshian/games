    ...
    <main className="page caregiver-page">
      ...
      <section className="caregiver-card caregiver-card--notes">
        ...
        <ul>
          ...
          <li>הקראה כרגע משתמשת ב־SpeechSynthesis של הדפדפן (גרסת V1), ולכן הקולות תלויים במה שמותקן במכשיר. אם אין קול זמין, המשחקים עדיין עובדים במלואם עם תמונות ומגע.</li>
          <li>
